    ...
    <div class="table-container">
        <div class="content-index">
            <div class="title">
                ...
                <p><i class="fa-solid fa-location-dot" style="color: #ffffff; margin-right: 10px"></i>Jamsil Sports Complex - Seould Olympic Stadium</p>
            ...
            <div class="mt-4">
                ...
                <div class="d-flex justify-content-center">
                    <img src="{{ asset ('images/seatplan.jpg') }}" class="seatplan">
                </div>
            </div>
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <p class="card-text"><i class="fa-solid fa-check-to-slot" style="color: #ffffff; margin-right: 10px"></i>Available seats : {{ $item->stock }}</p>
